    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String confirem_pass = reg_confirm_pass_field.getText().toString();

                if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(pass) & !TextUtils.isEmpty(confirem_pass)){

                    if(pass.equals(confirem_pass)){
